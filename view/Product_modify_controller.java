 ...
 * @author ryan
 */
public class Product_modify_controller implements Initializable {
    ...
    private ObservableList<Part> parts_current = FXCollections.observableArrayList();
    private int product_index = product_get_modify_index();
    ...
    {
        Product product = product_get_inventory().get(product_index);
        //product_id = sample.module.Inventory.product_get_id();
        product_id = product_get_inventory().get(product_index).product_get_id();
        product_field_id.setText("Primary Key:  " + product_id);
        product_field_name.setText(product.product_get_name());
        product_field_quantity.setText(Integer.toString(product.product_get_quantity()));
        product_field_price.setText(Double.toString(product.product_get_price()));
        product_field_min.setText(Integer.toString(product.product_get_min()));
        product_field_max.setText(Integer.toString(product.product_get_max()));
        parts_current = product.product_get_parts();
    ...
    private void product_save(ActionEvent event) throws IOException
    {
        ...
        try
        {
            ...
            else
            {
                ...
                Inventory.product_update(product_index,in_product);
